  ...
  <div class="min-h-screen bg-gray-100">
    ...
    <div class="lg:hidden fixed top-4 left-4 z-50">
      <button
        ...
        class="bg-white p-2 rounded-md shadow-md text-gray-600 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500"
      >
    ...
    <!-- Mobile menu overlay -->
    <div v-if="mobileMenuOpen" class="mobile-menu lg:hidden" @click="mobileMenuOpen = false">
    ...
    <!-- Desktop Sidebar -->
    <div class="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:w-64 lg:bg-white lg:shadow-lg">
      <div class="flex flex-col h-full">
        <!-- Logo -->
