        ...
        <div class="flex justify-between items-center h-16">
          ...
          <div class="flex items-center space-x-2 sm:space-x-4">
            ...
            <button
              ...
              class="lg:hidden p-2 rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all duration-200"
            >
          ...
          <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white shadow-xl">
            <div class="flex flex-col h-full">
              ...
              <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200">
                <h1 class="text-xl font-bold text-primary-600">Srijani</h1>
                <button
